...
#Removing values when store is closed
indexNames = df_sales[df_sales['Open'] == 0].index
...
plt.title("Date vs Sales (Single Store)")
plt.xlabel("Date")
...
plt.clf()
plt.title("Predicted vs Actual (Single Store)")
plt.xlabel("Date")
plt.ylabel("Sales Quantity")
